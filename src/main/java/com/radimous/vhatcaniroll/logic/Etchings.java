...
import com.radimous.vhatcaniroll.logic.modifiervalues.EtchingModifierValues;
...
public class Etchings {
    public static List<Component> getEtchingInfo(VaultEtchingConfig.EtchingEntry etching) {
        ArrayList<Component> modList = new ArrayList<>();
        var attributes = etching.getAttributes();
        for (EtchingTierConfig.EtchingModifierTierGroup modTierGroup: attributes) {
            if (Config.DEBUG_ETCHINGS.get()) {
